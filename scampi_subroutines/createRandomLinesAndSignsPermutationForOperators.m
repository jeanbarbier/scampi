function [rperm, flipedSigns, rperm2] = createRandomLinesAndSignsPermutationForOperators(numBlockC, numBlockL, J, Mblock, Nblock)
...
for (c = 1 : numBlockC)
    ...
    if fullPerm(end) ~= 1;
        ...
        fullPerm(fullPerm == 1) = fullPerm(1);
        rpC = fullPerm(2 : end);
    end    
